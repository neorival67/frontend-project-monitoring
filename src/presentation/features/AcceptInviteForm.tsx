    ...
    return (
      <div className="auth-card">
        <div className="auth-header">
          ...
          <h1 className="auth-title">Token Tidak Ditemukan</h1>
          <p className="auth-subtitle">
            Link undangan tidak valid. Pastikan Anda menggunakan link yang benar
            dari email undangan Anda.
          </p>
        </div>
  ...
  return (
    <div className="auth-card">
      ...
      <div className="auth-header">
        ...
        <h1 className="auth-title">Terima Undangan</h1>
        <p className="auth-subtitle">
      ...
      >
        ...
        <div className="auth-input-group">
          <label htmlFor="invite-password" className="auth-label">
            Password Baru
          </label>
        ...
        {/* Confirm Password */}
        <div className="auth-input-group">
          <label htmlFor="invite-confirm-password" className="auth-label">
            Konfirmasi Password
          </label>
          <div className="auth-input-wrapper">
            <span className="auth-input-icon"><IconLock /></span>
